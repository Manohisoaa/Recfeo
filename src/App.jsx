function App() {
  ...
  return (
    ...
    //   <p className="text-2xl">Hello les fillllessss</p>
    // </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
          ...
          <div className="space-y-14">
            ...
            <div className="flex gap-x-5">
              ...
              <div className="grow">
                <h4 className="text-white font-semibold">We are hiring</h4>
                <p className="mt-1 text-neutral-400">We are thrilled to announce that we are expanding our team and looking for talented individuals like you to join us.</p>
                <p className="mt-2">
